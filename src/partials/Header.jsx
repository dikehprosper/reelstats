  ...
  return (
    ...
    >
      <div className="max-w-6xl mx-auto px-4 sm:px-6 ">
        <div
          className="flex items-center justify-between h-20, position-relative "
          style={{
            color: "white",
          }}
        >
          ...
          <div className="shrink-0 mr-4">
            ...
            >
              <img src={zz} alt="" srcset="" height="120px" width="120px" />
            </Link>
          </div>
          ...
          <div
            style={{
              ...
              ":hover": {
                ...
                cursor: "pointer", // New background color on hover
              },
            }}
            ...
            >
              <ul className="bg-gray-800 px-4 py-2">
                <li>
                  <Link
                    to="/"
                    className="font-medium w-full inline-flex items-center justify-center border border-transparent px-4 py-2 my-2 rounded-sm text-purple-700  hover:bg-gray-200 transition duration-150 ease-in-out"
                  >
                    Home
                  </Link>
                </li>
